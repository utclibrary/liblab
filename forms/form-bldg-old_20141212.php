    ...
    ================================================== --><ul class="breadcrumb" data-original-title="breadcrumb"></ul>
		...
		if (isset($_POST["submit"])) {
		  ...
		  if ($resp->is_valid) {
                ...
                "      Ok? : ".$_POST['ok']."\n".
		"   Why not? : ".$_POST['text']."\n";
                $recipients = "lisa-price@utc.edu,layton-jackson@utc.edu,Cheryl-VanMater@utc.edu,theresa-liedtka@utc.edu,joshua-cash@utc.edu,anna-lane@utc.edu,mike-bell@utc.edu,virginia-cairns@utc.edu,brian-rogers@utc.edu,laird-leathers@utc.edu,jeff-blackhart@utc.edu";
		    mail($recipients, "[Library Walkthrough]: ".$_POST['ok'],$body,$headers);
		    echo "<h1>The form has been submitted.</h1><p>Return to the <a href='http://www5.lib.utc.edu/forms/form-bldg.php'>Library Walkthrough</a> page or the <a href='http://www.utc.edu/library/'>Library Home</a> page.</body></html>";
		    exit;
		  } else {
