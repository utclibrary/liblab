...
<!--[if gt IE 8]><!--><html lang="en-gb"><!--<![endif]-->
   <head>
      ...
      <title>IT Issues | UTC Library</title>
    ...
    ================================================== --><ul class="breadcrumb" data-original-title="breadcrumb"></ul>
		...
		if (isset($_POST["submit"])) {
		  ...
		  if ($resp->is_valid) {
                ...
                "From: ".$_POST['name']."\n".
				"Issue: ".$_POST['text']."\n";
                $recipients = "brian-rogers@utc.edu,lib-it@utc.edu";
		    mail($recipients, "[Library IT Issues]: ".$_POST['name'],$body,$headers);
		    echo "<h1>The form has been submitted.</h1><p>Return to the <a href='http://www5.lib.utc.edu/forms/form-it.php'>Library IT Issues</a> page.";
		    exit;
		  } else {
       ...
       <?php if (isset($error)) { echo "<span class='error'>Stop Spam, Read Books: your entry did not match the image. <a href='#submit'>Try again.</a></span>"; } ?>
		...
		<option<?php if (isset($_POST['name']) && ($_POST['name'] == "Andrea")) { echo " selected"; } ?> value="Andrea">Andrea</option>
		<option<?php if (isset($_POST['name']) && ($_POST['name'] == "Bo")) { echo " selected"; } ?> value="Bo">Bo</option>        
		<option<?php if (isset($_POST['name']) && ($_POST['name'] == "Brian")) { echo " selected"; } ?> value="Brian">Brian</option>
        <option<?php if (isset($_POST['name']) && ($_POST['name'] == "Jeff")) { echo " selected"; } ?> value="Jeff">Jeff</option>
        <option<?php if (isset($_POST['name']) && ($_POST['name'] == "Laird")) { echo " selected"; } ?> value="Laird">Laird</option>
                    </select></p>
       
                 <h3>What Is It?</h3>
                    <p>
                    	<textarea wrap="Virtual" cols="60" rows="10" name="text"><?php if (isset ($_POST['text'])) { echo $_POST['text']; } ?></textarea>
		            </p>
            <a name="submit"></a>
		        <h3>Spamma Jamma</h3>
                <p>
...
================================================== -->
      <footer class="achieve-2">
         <div class="container">
            ...
            <div class="row">
               <div class="span12">
                  <p class="achieve pushup center">Dept.&nbsp;6456
                     &nbsp;|&nbsp;
                      615 McCallie Ave
                     &nbsp;|&nbsp;
...
<p class="fineprint">An engaged, metropolitan campus of the <a id="legal-ut" href="http://www.tennessee.edu/" target="_blank">University of Tennessee System</a></p>
