        ...
        function checkWholeForm(theForm) {
		    ...
		    why += checkPhone(theForm.eve_phone.value);
		    why += checkEmail(theForm.email.value);
		    why += isEmpty(theForm.utcid.value, "UTCID");
		    why += isEmpty(theForm.dept.value, "Department");
		    why += isEmpty(theForm.number.value, "Course Number");
		    why += isEmpty(theForm.title.value, "Course Title");
