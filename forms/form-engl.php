...
<html>
    <head>
        <title>The Lupton Library - English 121/122 Form</title>
...
#$recipients = "brian-kysela@utc.edu";
		    ...
		    mail($recipients, "[Library Form] English 121/122 with ".$_POST['name'],$body,$headers);
	    ...
	    <form action="" method="post" onSubmit="return checkWholeForm(this);" />
		    ...
		    <fieldset>
		        ...
		        <p>
		            Core concepts to be covered, included in every session:
                </p>
                <div class="column-1">
                <em>English 121</em>
		            <ul>
		                <li>
		                 Understanding the Library vs. the Internet</li>
		                <li>Constructing a database search with Keywords</li>
		                <li>Judging / Evaluating your results</li>
		            </ul>
                </div>
                <div class="column-2">
                <em>English 122</em>
                    <ul>
					    <li>Differentiating between scholarly and popular sources</li>
    					<li>Using databases besides Infotrac (different databases have different purposes)</li>
    					<li>Citation basics</li>
                    </ul>
                </div>
                <div class="clear"></div>
		        <p>
