        ...
        function checkWholeForm(theForm) {
		    ...
		    why += checkDropdown(theForm.status.selectedIndex);
		    why += isEmpty(theForm.course.value, "Department and Course Name");
		    why += isEmpty(theForm.date_time.value, "Preferred Consultation Date");
		    why += isEmpty(theForm.alternate_date_time.value, "Alternate Consultation Date");
		    why += isEmpty(theForm.topic.value, "Research Topic");
            /*
