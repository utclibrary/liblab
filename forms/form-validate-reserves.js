        ...
        function checkWholeForm(theForm) {
		    var why = "";
		    why += isEmpty(theForm.needed.value, "Provided information needed");
			why += isEmpty(theForm.clear.value, "Material was clear");
			why += isEmpty(theForm.knowledge.value, "Librarian was knowledgeable");
			why += isEmpty(theForm.least.value, "Least useful information");
		    why += isEmpty(theForm.most.value, "Most useful information");
