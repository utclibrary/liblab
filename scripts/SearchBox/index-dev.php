...
foreach ($dbFormatKey as $key => $i){
      ?>
		...
		{
      console.log('160 onchange function called');
			$('#resetDb').show();
      $('#descriptions').empty();
      $('span.db-legend').hide();
...
<form class='form-search' name='databases' action='http://www5.utc.edu/databases/LGForward.php' method='get' target='_blank'>
